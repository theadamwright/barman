...
class StandbyPostgreSQLConnection(PostgreSQLConnection):
    ...
    Works almost exactly like a regular PostgreSQLConnection except it accepts a
    ...
    def __init__(
        ...
        self.primary = PostgreSQLConnection(
            primary_conninfo, immediate_checkpoint, slot_name, application_name
        )
    ...
    def _stop_backup(self, backup_fun):
        """
        ...
        to stop the concurrent backup on the standby. The WAL switch is intended to
        allow the pg_backup_stop call to complete when running against a standby with
